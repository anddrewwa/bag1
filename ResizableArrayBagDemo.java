...
public class ResizableArrayBagDemo
{
	public static void main(String[] args) 
	{
      ...
      ResizableArrayBag<String> aBag = new ResizableArrayBag<>(3);
      ...
      ResizableArrayBag<String> bag2 = new ResizableArrayBag<>(2);
      String[] content = {"D", "D", "B", "E"};
      testAdd(bag2, content);

      ResizableArrayBag<String> bag = aBag.difference(bag2);
      displayBag(bag);
